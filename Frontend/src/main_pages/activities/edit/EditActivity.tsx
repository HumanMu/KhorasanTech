...
export default function EditActivity({
  ...
  const initialState = selectedActivity || {  // spørgsmåltegnerne betyder, hvis aktivitien er tomme, så skal den erstates med hvad der står til højre for prameteren, dvs. ingenting
    id: '',
    title: '',
    date: '',
    description: '',
    ...
    <>
      <Drawer size={"xl"} isOpen={isOpen} onClose={onClose} >
        <Box marginBottom={10} height={'100%'}>
          ...
          >
            <DrawerCloseButton />
            <Image borderRadius={10} marginBottom={5} src={activity.imageUrl ? activity.imageUrl : Shirdagh} />
            <Box borderRadius={10}  marginBottom={50}>
              <FormControl isRequired>
                <FormLabel marginTop={2} marginBottom={0}>Title</FormLabel>
                  <Input {...Header} 
              ...
              <DrawerBody padding={0}>
                <FormControl isRequired>
                  <FormLabel marginTop={2} marginBottom={0}> Description</FormLabel>
                  <Textarea
              ...
              <Button backgroundColor={'red'} textColor={'white'} marginTop={2} onClick={handleEditSubmit}>
                Save
              </Button>
              <Button backgroundColor={'red'} textColor={'white'} marginTop={2} onClick={handleCancelSubmit}>
                Cancel
              </Button>
            </Box>
          </DrawerContent>
